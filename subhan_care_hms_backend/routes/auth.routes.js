...
const { loginUser, getMe, forgotPassword, resetPassword, verifyOTP, updateProfile, changePassword, verifyPasswordChangeOtp, confirmPasswordChange } = require('../controllers/auth.controller');
